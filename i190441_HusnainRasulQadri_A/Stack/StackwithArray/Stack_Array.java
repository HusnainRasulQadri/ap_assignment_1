//Program to implement Stack_Array using an array.
...
public class Stack_Array{
	...
	static public void push(int number){
		...
		if(addPointer>=array.length){
			System.out.println("Stack_Array is Full!");
			return;
		}
	...
	static public int pop(){
		//if stack is empty.
		if(addPointer==0){
			System.out.println("Stack_Array is Empty!");
			return -1;
		}
	...
	static public void display(){
		if(addPointer==0){
			System.out.println("Empty Stack_Array.");
			return;
		}
		System.out.print("Stack_Array : ");
