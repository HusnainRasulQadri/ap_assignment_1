//Program to implement Stack_LinkedList using LinkedList.
public class Stack_LinkedList{
	...
	static public int top(){
		if(head==null){
			System.out.println("Stack_LinkedList is Empty!");
			return -1;
		}
	...
	static public int pop(){
		...
		if(head==null){
			System.out.println("Empty Stack_LinkedList.");
			return -1;
		}
	...
	static public void display(){
		...
		System.out.println();
		System.out.println("Stack_LinkedList ");
		Node temp=head;
		while(temp!=null){
			System.out.println("----------");
