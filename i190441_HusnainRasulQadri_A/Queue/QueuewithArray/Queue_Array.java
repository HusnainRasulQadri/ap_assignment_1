//Program to implement Circular Queue_Array using an array.
...
public class Queue_Array{
	...
	static public void enqueue(int number){
		...
		if(addPointer+1==removePointer){
			System.out.println("Queue_Array is Full.");			
			return;
		}
	...
	static public int dequeue(){
		...
		if(removePointer==addPointer){
			System.out.println("Empty Queue_Array.");
			return -1;
		}
